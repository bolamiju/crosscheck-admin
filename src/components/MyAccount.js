...
const MyAccount = () => {
    ...
    return (
      ...
      />
        ...
        <h5 style={{textAlign:"center",marginLeft:"-30px"}}>Enter email to Reset your password</h5>
            <input
            type="text"
            name="email"
            value={email}
            ...
            className="input"
            />
            <button onClick={requestPasswordReset} className="create-button" style={{marginLeft:"10px"}}>Submit</button>
            </div>
            </DashboardBody>
        </DashboardLayout>
    )
